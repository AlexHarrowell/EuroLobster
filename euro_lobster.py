...
def get_commissioner_detail(commish, weightings):
	...
	if record['name'] == u'Günther Oettinger':
		record['staffers'][u'eric mamer'] = u'deputy chef de cabinet' #xfers to DG GROW as director, competitiveness as of 03/2016
...
#meetings with staffers come as a package and include a name field. which can include multiple staffers.	
							...
							if u'heidi jern' in meeting['staffer']:
